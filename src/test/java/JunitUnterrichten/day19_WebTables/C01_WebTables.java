package JunitUnterrichten.day19_WebTables;
...
//    printData(2,3);  => 2. satır, 3. sütundaki veriyi yazdırsın.
    ...
    public void printData(int satir, int sutun) {
        ...
        //driver.findElements(By.xpath("//table[@id='table1']//td[5]"));bu ifadede 3ve 5 in üstüne gelip
        //tirnak icine aliriz daha sonrada bu sayilari siler yerine iki arti koyariz ve artilarin arasini
        // acarak satir ve sutün yazariz.yani concatination yapariz

        WebElement belirliVeri = driver.findElement(By.
                xpath("//table[@id='table1']/tbody/tr[" + satir + "]/td[" + sutun + "]"));
