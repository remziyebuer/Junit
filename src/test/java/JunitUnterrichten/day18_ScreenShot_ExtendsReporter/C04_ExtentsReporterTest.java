package JunitUnterrichten.day18_ScreenShot_ExtendsReporter;
...
public class C04_ExtentsReporterTest extends TestBase {
    /*
           EXTENTREPORT kullanabilmemiz için;
               ...
               4-Rapora test ile ilgili bilgiler girebilmek için ExtentTest class'ından bir obje
                oluşturulur
            */
    ...
    public void extentReportTest() {
        ...
        extentReports.setSystemInfo("Tester","Remziye Bür");
   ...
   //raporu cift tiklayip chrome isaretinden ya da bir defa tiklayip open in sonra chrome deyip acabiliriz
