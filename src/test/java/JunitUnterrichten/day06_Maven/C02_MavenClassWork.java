...
//    Sign in buttonuna tıklayın
     ...
     driver.navigate().back();//hata oldugu icin back yaptim


//    Pay Bills sayfasına gidin
     driver.findElement(By.xpath("//strong[text()='Online Banking']")).
             click();//OnlineBanking linline tıklıyoruz


     driver.findElement(By.xpath("//span[@id='pay_bills_link']")).
             click();//PayBill linlini tıklıyoruz
...
//    Date kısmına “2023-03-27” yazdırın
     driver.findElement(By.xpath("//input[@id='sp_date']")).
             sendKeys("2023-03-27");
